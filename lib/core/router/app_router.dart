...
///
/// Route structure:
///   /splash          → SplashScreen (startup auth check)
///   /login           → LoginView
///   /register        → RegisterScreen
///   /                → HomeView (shell with bottom nav)
///     /market        → MarketScreen
///     /market/:symbol→ CoinDetailScreen
///     /portfolio     → PortfolioScreen
///     /news          → MarketNewsScreen
///     /news/:title   → NewsDetailScreen
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      // If logged in and on auth pages, redirect to market
      if (authState.isLoggedIn && isOnAuth) {
        return '/market';
      }
